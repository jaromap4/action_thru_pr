class GitCommand {
    ...
    status(){        
        ...
        */
        let wd_property_names = Object.getOwnPropertyNames(this.working_directory.new_changes);
        let message = `You have ${wd_property_names.length} change/s.`;
        if(wd_property_names.length == 0) message += '\n';
